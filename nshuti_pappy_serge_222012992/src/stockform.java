...
public class stockform extends JFrame implements ActionListener {
    ...
    stockform() {
        catidLabel = new JLabel("category id:");
        catidLabel.setBounds(20, 20, 100, 40);
        catidTextField = new JTextField();
        catidTextField.setBounds(100, 20, 200, 40);

        nameLabel = new JLabel(" Name of items:");
        nameLabel.setBounds(20, 100, 100, 40);
        nameTextField = new JTextField();
        nameTextField.setBounds(100, 100, 200, 40);

        descriptionLabel = new JLabel("email:");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == submitButton) {
            ...
            try {
                ...
                PreparedStatement stmt = con.prepareStatement("INSERT INTO stock (cat_id,name,description,unit_price,quantity) VALUES (?,?,?,?,?)");
